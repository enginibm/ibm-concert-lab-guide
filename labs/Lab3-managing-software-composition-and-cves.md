...
4. Search for github
  ...
  <br><img src="../images/concert_create_github_connection1.png" alt="drawing" width="600"/>

5. Select the card and enter following value:
   
- **Name**: Github.ibm connection
- **Host**: [https://github.ibm.com/api/v3](https://api.github.com)
- **Personal access token**: your personal access token you created in step III of [Lab0](Lab0-setup.md)
- Click **Validate connection**

  <br><img src="../images/concert_create_github_connection2.png" alt="drawing" width="600"/>
...
2. Select a CVE
  ...
  <br><img src="../images/concert_cve_openticket1.png" alt="drawing" width="600"/>
...
6. Click **Open ticket+**
  ...
  <br><img src="../images/concert_cve_openticket2.png" alt="drawing" width="600"/>
...
8. Click **Open**
  ...
  <br><img src="../images/concert_cve_openticket3.png" alt="drawing" width="600"/>

9. On the CVE page that is displayed now, select your ticket to see it on github

  <br><img src="../images/concert_cve_openticket4.png" alt="drawing" width="600"/>
  <br><img src="../images/concert_cve_openticket5.png" alt="drawing" width="600"/>
